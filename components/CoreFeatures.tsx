...
const zones = [
  {
    ...
    mobileDesc: "Squat racks, Olympic platforms, and calibrated dumbbells up to 150 lbs so your training never pauses.",
    ...
    specs: ["10+ Squat Racks", "Eleiko Plates", "Dumbbells up to 150 lbs", "Deadlift Platforms"],
  },
  {
    id: "02",
    ...
    mobileDesc: "Concept2 rowers, SkiErgs, assault air-bikes, and curved treadmills for peak endurance.",
    ...
    specs: ["Concept2 Rowers", "Assault AirBikes", "Curved Treadmills", "StairMasters"],
  },
  {
    id: "03",
    ...
    mobileDesc: "40-meter sprint turf for heavy prowler sled pushes, tire flips, and agility drills.",
    ...
    specs: ["40m Sprint Turf", "Prowler Sleds", "Plyo Jump Boxes", "Battle Ropes"],
  },
  {
    id: "04",
    ...
    mobileDesc: "Hyperice percussion guns, NormaTec compression boots, and Finnish dry sauna suites.",
    ...
    specs: ["NormaTec 3 Boots", "Hypervolt Percussion", "Swedish Dry Sauna", "Infrared Bays"],
  },
  {
    id: "05",
    ...
    mobileDesc: "40+ weekly classes: HIIT, CrossFit conditioning, and Power Yoga led by master coaches.",
    ...
    specs: ["40+ Classes Weekly", "Surround Sound", "HIIT & Power Yoga", "CrossFit Studio"],
  },
];
...
export default function CoreFeatures() {
  ...
  return (
    <section
      ref={containerRef}
      id="classes"
      className="relative bg-[#000000] border-t border-gray-900 overflow-hidden"
      style={{ minHeight: "100vh" }}
    >
      {/* Viewport Container */}
      <div
        ref={pinTargetRef}
        className="w-full min-h-screen lg:h-screen flex flex-col justify-center overflow-hidden py-10 lg:py-0"
      >
        {/* Background radial ambient glow */}
        <div
          className="absolute right-1/4 top-1/2 -translate-y-1/2 w-[350px] sm:w-[700px] h-[350px] sm:h-[700px] rounded-full pointer-events-none transition-colors duration-500"
          style={{
        ...
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col justify-center h-full max-h-[880px]">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-5 sm:mb-8 gap-3 sm:gap-4">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full bg-brand-950/40 border border-brand-500/30 text-brand-400 font-bold text-[11px] sm:text-sm uppercase tracking-widest mb-2">
                <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-brand-400" />
                15,000 SQ FT SANCTUARY
              </div>
              <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-white uppercase tracking-tighter leading-tight">
                World-Class Zones
              </h2>
              <p className="text-xs sm:text-base md:text-lg text-gray-400 mt-1 max-w-2xl">
                Meticulously engineered training ecosystems in Aashiana. Tap or scroll to explore each zone.
              </p>
            </div>

            {/* Step Progress Counter & Bar */}
            <div className="w-full md:w-64 shrink-0 mt-2 sm:mt-0">
          ...
          <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto pb-2 mb-5 sm:mb-8 no-scrollbar select-none">
            {zones.map((zone, idx) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  className={`px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-full text-xs sm:text-sm font-black uppercase tracking-wider whitespace-nowrap transition-all duration-200 flex items-center gap-1.5 sm:gap-2 border cursor-pointer ${
                    isSelected
          ...
          {/* Un-squished Responsive Card Stage */}
          <div className="relative w-full min-h-[380px] sm:min-h-[420px] lg:min-h-[440px]">
            {zones.map((zone, idx) => {
              ...
              return (
                ...
                >
                  {/* Single Clean Card on Mobile (< lg), Pinned Split View on Desktop (lg:) */}
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-8 items-stretch h-full">
                    
                    {/* Left Visual Card (Desktop: 5 cols / Mobile: compact header) */}
                    ...
                    {/* Right Details Card (Desktop: 7 cols / Mobile: full spacious card) */}
                    <div className="lg:col-span-7 h-full flex flex-col">
                      <div className="w-full h-full bg-[#0a0a0a] border border-gray-800 rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-8 lg:p-10 flex flex-col justify-between shadow-2xl relative overflow-hidden">
                        <div>
                          ...
                          <div className="flex items-center justify-between mb-3 lg:hidden">
                            <div className="flex items-center gap-2.5">
                              ...
                              <span
                                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider border ${zone.tagClass}`}
                              >
                                {zone.category}
                              </span>
                            </div>
                          ...
                          <h3 className="text-xl sm:text-3xl lg:text-4xl font-black text-white mb-2 sm:mb-3 leading-tight uppercase tracking-tight">
                            {zone.title}
                          </h3>

                          {/* Concise mobile text, full desktop text */}
                          <p className="text-gray-300 text-xs sm:text-base lg:text-lg leading-relaxed mb-4 sm:mb-6">
                          ...
                          <div className="mb-4 sm:mb-6">
                            <h4 className="text-[10px] sm:text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 sm:mb-3">
                              Key Highlights:
                            </h4>
                            <div className="flex flex-wrap gap-1.5 sm:gap-2.5">
                              {zone.specs.map((spec, sIdx) => (
                                <div
                                  key={sIdx}
                                  className="px-3 py-1.5 sm:px-4 sm:py-2 rounded-xl bg-gray-900/90 border border-gray-800 text-gray-300 text-[11px] sm:text-sm font-semibold flex items-center gap-1.5 sm:gap-2"
                                >
                        ...
                        {/* Footer Actions */}
                        <div className="pt-3 sm:pt-4 border-t border-gray-900 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
                          ...
                          <a
                            href="#pricing"
                            className="w-full sm:w-auto bg-brand-500 hover:bg-brand-400 text-black px-6 py-2.5 sm:px-7 sm:py-3 rounded-full font-black text-xs sm:text-sm transition-all hover:-translate-y-0.5 shadow-[0_0_20px_rgba(212,255,62,0.25)] flex items-center justify-center gap-2 uppercase tracking-wider active:scale-95 shrink-0"
                          >
                            Experience Zone
